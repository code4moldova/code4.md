      ...
      <section className="bg-blue-100 pt-12 sm:pt-32 pb-56">
        <Container className="mb-20 sm:mb-32">
          ...
          <p className="w-full sm:w-3/5 xl:w-3/5 mx-auto">
            Implicarea ta contribuie la dezvoltarea societății noastre. Oferind câteva ore, know-how-ul tău sau o
            donație oricât de mică, ne ajută să identificăm atât problemele din comunitate cât și să dezvoltăm soluții
            digitale pentru o Moldovă mai bună. Vino alături de noi și susține aplicațiile civice!
          </p>
        </Container>
          ...
          <Row>
              ...
              <div className="bg-white border-t-8 border-blue-500 h-full flex flex-col">
                ...
                <div className="px-12 mb-8">
                  <p className="text-gray-800">
                    Dacă ai cunoștințe și aptitudini de programist, te poți implica ca voluntar Code For Moldova la
                    următorul HackDay. Hai să ne cunoaștem acolo și apoi, să dezvoltăm aplicații digitale care vor
                    schimba vieți spre bine.
                  </p>

                  <div className="my-12">
                    <div className="-mb-2">
                      <span className="inline-flex items-center px-5 py-1 mb-2 mr-2 text-blue-500 border border-blue-500 rounded-md">
                        {rulerSvg} <span className="ml-2">Design</span>
                      </span>
                      <span className="inline-flex items-center px-5 py-1 mb-2 mr-2 text-pink-500 border border-pink-500 rounded-md">
                        {developerSvg} <span className="ml-2">Programare</span>
                      </span>
                      <span className="inline-flex items-center px-5 py-1 mb-2 mr-2 text-indigo-500 border border-indigo-500 rounded-md">
                        {searchSvg} <span className="ml-2">Cercetare</span>
                      </span>
                      <span className="inline-flex items-center px-5 py-1 mb-2 mr-2 text-yellow-800 border border-yellow-800 rounded-md">
                        {chatSvg} <span className="ml-2">Comunicare</span>
                      </span>
                      <span className="inline-flex items-center px-5 py-1 mb-2 mr-2 text-gray-600 border border-gray-600 rounded-md">
                  ...
                  <p>
                    Dacă posezi alte skill-uri din zona de comunicare, design, cercetare, organizare evenimente și ești
                    gata să donezi timp pentru susținerea activității Code For Moldova, atunci trimite-ne mai multe
                    detalii despre tine pe{' '}
                    <a className="text-blue-500" href="mailto:contact@code4.md">
                      contact@code4.md
                    </a>
                  </p>
                </div>
            ...
            <Column className="w-full xl:w-1/2 mb-8">
              <div className="bg-white border-t-8 border-blue-700 h-full flex flex-col">
                ...
                <div className="px-12 mb-8">
                  <p className="text-gray-800">
                    Code for Moldova se bazează pe voluntariat, însă activitatea noastră implică multe cheltuieli,
                    precum:
                  </p>
                  ...
                  <p>
                    Dacă îți plac{' '}
                    <Link href="/solutions">
                      <a className="text-blue-500">aplicațiile noastre</a>
                    </Link>
                    , poți investi în ele printr-o donație. Fiecare donație ajută la continuarea activității noastre și
                    la dezvoltarea și la mentenanța soluțiilor digitale pentru societate.
                  </p>
                </div>
                <Link href="/donate">
        ...
        <Container>
          <div className="bg-white w-full xl:w-1/2 mx-auto border-t-8 border-blue-900 flex flex-col">
            ...
            <a
              rel="noopener noreferrer"
              target="_blank"
              href="mailto:contact@code4.md"
              className="mt-auto py-4 px-12 w-full bg-blue-900 hover:bg-blue-700 text-white text-center">
              Hai să vorbim
            </a>
          </div>
        </Container>
