  ...
  return (
    <section className="py-24">
      <Container>
        ...
        <p className="mb-16">
          Voluntarii sunt motorul în toate procesele de lucru. În cadrul Code For Moldova, ei sunt cei care generează
          cele mai bune idei și le aduc la viață. YOU want it, THEY make it happen!
        </p>
