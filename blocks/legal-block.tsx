  ...
  return (
    <section className="py-24">
      <Container>
        ...
        <p >
            Găsiți o manieră în care oamenii pot fi productivi cu calitățile și competențele pe care le au (tehnice
             sau nu) și energia fiecăruia.
        </p>
        <p >
            Folosiți exprimări ca “da/și”, în loc de “nu/dar”.
        </p>
        <p >
            Încurajați membrii și participanții să asculte pe cât de mult vorbesc.</p>
        <p >
            Încercați să construiți instrumente și tehnologii accesibile publicului. Vor fi prioritizate activitățile
            care sunt în avantajul utilizării de către publicul larg, iar nu individuale, private.</p>
        <p >
            Prioritizează accesul și exprimarea opiniilor de către grupurile care sunt, în mod traditional, excluse de
             la procesul civic.
        </p>
        <p >
            Depune eforturi pentru a se asigura de buna reprezentare a comunității în procesul de planificare, design
            și implementare a soluției tehnice. Acest lucru include încurajarea participării femeilor, minorităților și
             grupurilor în mod traditional marginalizate.
        </p>
        <p >
            Implică în mod activ în procesul de luare a deciziilor grupurile din comunitate și acelea care au expertiză
            pe subiectul în discuție.
        </p>
        <p >
            Se asigură că relațiile și conversațiile dintre membrii comunității, reprezentanții autorităților locale și
            partenerii comunității ramân respectuose, promovează participarea și productivitatea.
           Asigură un mediu în care oamenii nu sunt supuși discriminării sau hărțuirii.
        </p>
        <p >
        Code for Moldova este o organizație apolitică, și nu se va asocia cu niciun partid politic.
        </p>
        <p >
